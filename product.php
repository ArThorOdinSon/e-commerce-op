...
<div class="container-fluid py-5">
    <div class="container">
        ...
        <p class="mb-5">Embrace a healthier lifestyle with TimeZenith Smartwatch. This premium device is equipped with advanced features to monitor your heart rate, track sleep patterns, measure blood pressure, and detect blood oxygen levels. Perfect for those who seek to maintain an active and healthy lifestyle.</p>
        </div>
        <div class="row g-4">
            <?php foreach ($products as $product) : ?>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="product-item text-center border h-100 p-4">
                        ...
                        <a href="#" class="h6 d-inline-block mb-2"><?php echo $product['name']; ?></a>
