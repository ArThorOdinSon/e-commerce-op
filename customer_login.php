...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT id, username, password FROM customer_users WHERE username = ?");
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <p class="mb-0">Don't have an account? <a href="customer_register.php">Register</a></p>
                    </div>
                </div>
            </div>
        </div>
